...
public class MainMenuScenario implements FsmScenario {
    ...
    private OutgoingMessage menu(IncomingMessage incoming) {
        return ready(
                ...
                Быстрые сценарии:
                • Меню кухни, Бар, Коктейли или Винная карта
                • Видео-тур
                • забронировать стол / Бронь стола
                • Связаться с командой
                • сабраж, афиша или концепция AERIS
                • изменить или отменить бронь
                • отзыв, чаевые, донат, аукцион или мерч
    ...
    private OutgoingMessage clarification(IncomingMessage incoming) {
        return ready(
                incoming,
                "Я пока не уверен, какой сценарий нужен. Нажмите кнопку ниже или напишите проще: меню кухни, бар, коктейли, вино, видео-тур, бронь стола, афиша, отзыв или команда.",
                "MAIN_MENU_CLARIFY"
        );
    }
