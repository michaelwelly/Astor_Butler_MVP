...
public class Neo4jScenarioGraphSeeder implements ApplicationRunner, AutoCloseable {
    ...
    private void seedTransitions(Session session) {
        List<List<String>> transitions = List.of(
                ...
                List.of("TABLE_BOOKING_INTENT", "TABLE_BOOKING_COLLECT_DATE", "missing date"),
                ...
                List.of("TABLE_BOOKING_COLLECT_PARTY_SIZE", "TABLE_BOOKING_WAIT_TABLE_SELECTION", "party size captured and plan sent"),
                List.of("TABLE_BOOKING_WAIT_TABLE_SELECTION", "TABLE_BOOKING_WAIT_HOSTESS_CONFIRMATION", "table selected"),
